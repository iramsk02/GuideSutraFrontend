...
export default function Recommendations() {
  ...
  useEffect(() => {
    try {
      ...
      if (raw) {
        ...
        // If profile has no interests, assume assessment is needed
  ...
  const courses = useMemo(() => {
    ...
    if (i.has("commerce") || i.has("business"))
      out.push("B.Com (Hons)", "BBA");
          ...
          {needsAssessment ? (
            <div className="text-center space-y-4 py-6">
              <p className="text-muted-foreground">
                You haven’t taken the assessment yet. Complete it to unlock
            ...
            <>
              ...
              <section>
                ...
                <div className="flex flex-wrap gap-2">
                  {["AI Engineer", "Business Analyst", "UX Designer"].map(
                    (c) => (
