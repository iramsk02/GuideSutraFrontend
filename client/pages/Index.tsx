...
import { ArrowRight, Banknote, BookOpenCheck, Briefcase, CalendarDays, GraduationCap, MapPin, School, Sparkles } from "lucide-react";
      ...
      <section>
        <div className="mb-3 flex items-end justify-between">
          <div>
            ...
            <p className="text-sm text-muted-foreground">Your personalized roadmap from degree to career outcomes</p>
          </div>
        </div>
        <Card>
      ...
      <div className="grid gap-6 lg:grid-cols-12">
        ...
        <section className="lg:col-span-8 space-y-3">
          <div className="flex items-end justify-between">
            <div>
              ...
              <p className="text-sm text-muted-foreground">Your curated list of colleges and programs</p>
            </div>
          </div>
        ...
        <aside className="lg:col-span-4 space-y-3">
          <div>
            ...
            <p className="text-sm text-muted-foreground">Stay on top of upcoming events</p>
          </div>
          <Card>
                ...
                {deadlines.map((d) => (
                  <li key={d.title} className="flex items-start justify-between gap-3">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      {d.urgency === "high" && (
                        <Badge className="bg-red-500 text-white hover:bg-red-500">High</Badge>
                      )}
                      {d.urgency === "medium" && (
                        <Badge className="bg-amber-500 text-white hover:bg-amber-500">Medium</Badge>
                      )}
                      {d.urgency === "low" && (
                        <Badge className="bg-emerald-500 text-white hover:bg-emerald-500">Low</Badge>
                      )}
                    </div>
                  </li>
                ))}
