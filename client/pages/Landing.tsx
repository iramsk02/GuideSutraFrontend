...
import { Briefcase, Building2, Medal, Twitter, Github, Linkedin } from "lucide-react";
      ...
      <header className="sticky top-0 z-20 w-full border-b bg-white/80 backdrop-blur">
        <div className="mx-auto max-w-6xl px-4 h-14 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <Link to="/mentorship" className="hidden text-sm text-muted-foreground md:block">Login</Link>
            <Link to="/colleges">
        ...
        <div className="grid items-center gap-8 md:grid-cols-2">
          <div>
            ...
            <div className="mt-6 flex flex-wrap gap-3">
              <Link to="/career-pathway"><Button size="lg" className="rounded-full px-6">Take Career Test</Button></Link>
              <Link to="/colleges"><Button size="lg" variant="outline" className="rounded-full px-6">Explore Colleges</Button></Link>
            </div>
          </div>
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          <Card className="rounded-2xl">
            <CardContent className="p-6 flex items-center gap-3">
              <div className="rounded-full bg-blue-100 p-3 text-blue-700"><Building2 /></div>
              <div>
          ...
          <Card className="rounded-2xl">
            <CardContent className="p-6 flex items-center gap-3">
              <div className="rounded-full bg-emerald-100 p-3 text-emerald-700"><Briefcase /></div>
              <div>
          ...
          <Card className="rounded-2xl">
            <CardContent className="p-6 flex items-center gap-3">
              <div className="rounded-full bg-violet-100 p-3 text-violet-700"><Medal /></div>
              <div>
