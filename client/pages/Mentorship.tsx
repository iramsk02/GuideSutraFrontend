...
const MENTORS: Mentor[] = [
  {
    id: "aisha",
    name: "Aisha Kapoor",
    title: "AI Engineer @ DeepMind",
    expertise: ["AI/ML", "Grad Applications", "Interview Prep"],
  ...
  },
  {
    ...
    expertise: ["Product", "PM Interviews"],
    image: "/placeholder.svg",
  },
  {
    id: "meera",
    name: "Meera Iyer",
    title: "PhD Physics @ MIT",
    expertise: ["Higher Studies", "Research"],
    image: "/placeholder.svg",
  },
  {
    id: "arjun",
    ...
    expertise: ["Data Science", "Career Switch"],
    image: "/placeholder.svg",
  },
  {
    id: "sana",
    name: "Sana Khan",
    title: "Counselor",
    expertise: ["Profile Building", "Scholarships"],
    image: "/placeholder.svg",
  },
  {
    id: "vivek",
...
const THREADS: Thread[] = [
  {
    ...
    question:
      "How do I balance school projects with preparing for AI internships?",
    replies: [
      {
        author: "Aisha (Mentor)",
        text: "Batch tasks using a weekly plan; target 2 LeetCode sets + 1 project feature per week.",
        mentor: true,
      },
      {
        author: "Rahul (Mentor)",
        text: "Showcase 1 polished project on your resume; quality beats quantity.",
        mentor: true,
      },
    ],
  },
  {
    ...
    replies: [
      {
        author: "Meera (Mentor)",
        text: "Strong letters + research experience > raw GPA; aim for at least one workshop paper.",
        mentor: true,
      },
    ],
  },
...
export default function Mentorship() {
  ...
  function confirmBooking() {
    ...
    toast.success(
      `Session booked with ${selectedMentor.name} on ${date.toDateString()} at ${slot}`,
    );
  }
